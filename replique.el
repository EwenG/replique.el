...
;; Package-Requires: ((emacs "30") (ivy "0.10.0") (clj-data "0.0.2"))
...
(defun replique/auto-complete (prefix)
  (when (not (null (replique/active-repl :tooling)))
    (replique/with-modes-dispatch
     ...
     (replique-clojure-mode . (apply-partially 'replique/auto-complete-clj prefix))
     (replique-clojure-clojurescript-mode . (apply-partially 'replique/auto-complete-cljs prefix))
     (replique-clojure-clojurec-mode . (apply-partially 'replique/auto-complete-cljc prefix))
     (t . nil))))
...
(defun replique/eldoc-documentation-function ()
  ...
  (when (not (null (replique/active-repl :tooling)))
    (replique/with-modes-dispatch
     ...
     (replique-clojure-mode . 'replique/repliquedoc-clj)
     (replique-clojure-clojurescript-mode . 'replique/repliquedoc-cljs)
     (replique-clojure-clojurec-mode . 'replique/repliquedoc-cljc)
     (t . nil))))
...
(defun replique/in-ns ()
  ...
  (replique/with-modes-dispatch
   ...
   (replique-clojure-mode . 'replique/in-ns-clj)
   (replique-clojure-clojurescript-mode . 'replique/in-ns-cljs)
   (replique-clojure-clojurec-mode . 'replique/in-ns-cljc)
...
(defun replique/company-backend (command &optional arg &rest ignored)
  ...
  (cond
   ...
   ((equal command 'prefix) (when (or (derived-mode-p 'replique-clojure-mode)
...
(defun replique/completion-at-point ()
  (when (or (derived-mode-p 'replique-clojure-mode)
            (derived-mode-p 'replique/mode))
...
(defun replique/maybe-change-ns ()
  (let ((active-repl (replique/active-repl '(:clj :cljs)))
    ...
    (replique/with-modes-dispatch
     (replique-clojure-mode . 'replique/maybe-change-ns-clj)
     (replique-clojure-clojurescript-mode . 'replique/maybe-change-ns-cljs)
     (replique-clojure-clojurec-mode . 'replique/maybe-change-ns-cljc)
     (t . nil))))
...
(defun replique/load-file (file-path)
  ...
  (replique/with-modes-dispatch
   (replique-clojure-mode . (apply-partially 'replique/load-url-clj
                                    (replique/buffer-url file-path)))
   (replique-clojure-clojurescript-mode . (apply-partially 'replique/load-url-cljs
                                          (replique/buffer-url file-path)))
   (replique-clojure-clojurec-mode . (apply-partially 'replique/load-url-cljc
                                     (replique/buffer-url file-path)))
...
(defun replique/reload-all ()
  ...
  (replique/with-modes-dispatch
   (replique-clojure-mode . 'replique/reload-all-clj)
   (replique-clojure-clojurescript-mode . 'replique/reload-all-cljs)
   (replique-clojure-clojurec-mode . 'replique/reload-all-cljc)))
...
(defun replique/jump-to-definition (symbol)
  ...
  (replique/with-modes-dispatch
   ...
   (replique-clojure-mode . (apply-partially 'replique/jump-to-definition-clj symbol))
   (replique-clojure-clojurescript-mode . (apply-partially 'replique/jump-to-definition-cljs symbol))
   (replique-clojure-clojurec-mode . (apply-partially 'replique/jump-to-definition-cljc symbol))
   (t . (user-error "Unsupported major mode: %s" major-mode))))
...
(define-derived-mode replique/mode comint-mode "Replique"
  ...
  (setq-local comint-output-filter-functions (add-to-list
                                              ...
                                              t))
  (set-syntax-table replique-clojure-mode-syntax-table)
