...
(defn ns-java-methods
  "Returns a list of potential java method name completions
...
(defn completions
  ...
  ([^String prefix ns]
   (sort (for [^String completion (potential-completions prefix ns)
